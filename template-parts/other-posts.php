...
<div class="posts-wrapper background-brand pt5 pb5">
	
	<div class="container container-wrapper">
	
		<div class="col">
			
			<h2 class="heading heading__md spacing1 font200 pb1">Other posts</h2>
			...
			<div class="other-posts container cols-4 cols-md-12">
				...
				<div class="col container cols-1-10 cols-block">
					...
					<a class="single-post" href="<?php echo get_permalink($single->ID); ?>">
						...
						<div class="heading heading__sm heading__light spacing2 font400 pb1 title"><?php echo get_field("hero_heading", $single->ID); ?></div>
					</a>
